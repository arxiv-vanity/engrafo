...
ENV LATEXML_COMMIT=e00debb5639dc57ce9e207d51294949301a1e514
RUN curl -L https://github.com/bfirsh/LaTeXML/tarball/$LATEXML_COMMIT | tar --strip-components 1 -zxf - \
    && perl Makefile.PL \
    && make \
    && make install
